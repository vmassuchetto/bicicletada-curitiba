...
$style2 = <<<STYLE2
<div style="width: 50px; height: 58px; margin: 2px 0px 4px 0px;">
			<div dir="ltr">
				<div style="height: 38px;">
					<div style="display:inline-block; background: no-repeat url('http://bicicletadacuritiba.org/wp-content/themes/bicicletada/img/identishare-bubble.png'); height: 35px; width: 50px; text-align: center; overflow: hidden; padding-top: 6px; font-size: 15px;">
						<a href="http://identi.ca/search/notice?q=${referringurl}&search=Search" target="_blank" style="vertical-align: top; color: #666666; font-family: 'Arial',sans-serif;"><b>$results</b></a>
					</div>
				</div>
				<div>
					<a href="http://identi.ca/index.php?action=newnotice&status_textarea=PAGE_TITLE_HERE" target="_blank" style="display: inline-block; background-image: url('http://bicicletadacuritiba.org/wp-content/themes/bicicletada/img/identishare-button.png'); font-family: arial; text-decoration: none; line-height: 1.2em; color: #000000; width: 50px; height: 20px;" title="Share on Identi.ca"></a>
				</div>
			</div>
		</div>
STYLE2;
